  ...
  'syms': { 'pyseatrials.basic': { 'pyseatrials.basic.CF_fn': ('basic_hydro_functions.html#cf_fn', 'pyseatrials/basic.py'),
            ...
            'pyseatrials.wind': { 'pyseatrials.wind.relative_wind_direction_from_true': ( 'wind.html#relative_wind_direction_from_true',
                                  ...
                                  'pyseatrials.wind.vertical_position_anemometer': ( 'wind.html#vertical_position_anemometer',
                                                                                     'pyseatrials/wind.py')},
            'pyseatrials.wind_res': { 'pyseatrials.wind_res.interpolate_cx': ( 'wind_resistance_factors.html#interpolate_cx',
                                                                               'pyseatrials/wind_res.py'),
                                      'pyseatrials.wind_res.load_wind_coefficients': ( 'wind_resistance_factors.html#load_wind_coefficients',
                                                                                       'pyseatrials/wind_res.py')}}}
